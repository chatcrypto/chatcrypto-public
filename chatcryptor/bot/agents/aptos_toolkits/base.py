...
from chatcryptor.bot.agents.aptos_toolkits.prompt import MAIN_PROMPT
...
from chatcryptor.bot.agents.aptos_toolkits.toolkit import AptosToolKit
from chatcryptor.bot.base.base_executor import BaseExecutor
from chatcryptor.enums.platform import SUPPORT_PLATFORM


class AptosExecutor(BaseExecutor):

    groups = [SUPPORT_PLATFORM.APTOS.value]
